...
public class Notes {
    ...
    While iterating, look for your desired checkbox (inspect the DOM to see which information provides you the
    indication that this is your desired checkbox).
    ...
    To check if the dropdown is multi-select or not, you can use the isMultiple() method, which returns a boolean true
    if it is a multi-select dropdown.
*/
}
